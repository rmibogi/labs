...
class PasswordGenerator:
    def __init__(self, main):
        ...
        self.label_main = tk.Label(main,
                                   text="Программа генерирует все возможные пароли. Каждый пароль состоит из К символов. Первые Т символов – "
                                        "\nзаглавные латинские буквы из набора ABCDWXYZ, остальные - латинские буквы или цифры из набора"
                                        "\nabcdwxyz0123456789.Обязательно наличие как минимум двух цифр. Все символы должны быть разные.", font='Arial 14')
